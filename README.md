...
If add_step is called during a step execution, the step will be appended to the end of the step list or right before the step defined in the `add_before` argument.
